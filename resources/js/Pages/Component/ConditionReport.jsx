            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2 bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-5">INFORMASI LAPORAN</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 text-xs text-gray-500 font-medium">
                            {/* Col 1 */}
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-5">INFORMASI DOKUMEN</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-5">INFORMASI UNIT / EQUIPMENT</h3>
                        <div className="space-y-3 text-xs text-gray-500 font-medium">
                    ...
                    {/* METER INFORMATION */}
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-5">METER INFORMATION</h3>
                        <div className="space-y-3 text-xs text-gray-500 font-medium">
                            <div className="flex items-center">
                    ...
                    {/* INFORMASI TAMBAHAN */}
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-5 flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <div className="mb-6">
                            <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-2 flex items-center gap-1.5">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-gray-600 pl-5 leading-relaxed">
                    ...
                    <div className="lg:col-span-2 bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <h3 className="text-xs font-extrabold text-[#0b132b] uppercase tracking-wider mb-4 flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <div className="flex items-start gap-2 mb-4">
                            ...
                            <div>
                                <h4 className="text-[11px] font-extrabold text-[#0b132b] uppercase tracking-wider">REPORT BY</h4>
                                <div className="text-[10px] text-gray-500">Mechanic / Inspector</div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <div className="flex items-start gap-2 mb-4">
                            ...
                            <div>
                                <h4 className="text-[11px] font-extrabold text-[#0b132b] uppercase tracking-wider">ACKNOWLEDGE BY</h4>
                                <div className="text-[10px] text-gray-500">Foreman / Supervisor</div>
                            </div>
                        </div>
                        <div className="h-16 border border-dashed border-gray-300 rounded mb-4"></div>
                        <div className="text-[10px] text-gray-500">Tanggal : ..............................................</div>
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        <div className="flex items-start gap-2 mb-4">
                            ...
                            <div>
                                <h4 className="text-[11px] font-extrabold text-[#0b132b] uppercase tracking-wider">APPROVED BY</h4>
                                <div className="text-[10px] text-gray-500">Superintendent</div>
                            </div>
                        </div>
                        <div className="h-16 border border-dashed border-gray-300 rounded mb-4"></div>
                        <div className="text-[10px] text-gray-500">Tanggal : ..............................................</div>
