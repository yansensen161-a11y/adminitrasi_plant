...
export default function Create({ auth, employee, approvals, formDefaults }) {
    ...
    const renderStatusBadge = (status) => {
        if (status === 'DIAJUKAN') return <span className="bg-blue-50 text-blue-600 font-bold px-3 py-1.5 rounded text-xs uppercase tracking-wide">DIAJUKAN</span>;
        if (status === 'DISETUJUI') return <span className="bg-green-50 text-green-600 font-bold px-3 py-1.5 rounded text-xs uppercase tracking-wide">DISETUJUI</span>;
        if (status === 'MENUNGGU') return <span className="bg-orange-50 text-orange-500 font-bold px-3 py-1.5 rounded text-xs uppercase tracking-wide">MENUNGGU</span>;
        return status;
    };
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        ...
                        <div className="space-y-5 text-sm text-gray-800 font-medium">
                            {/* Row 1 */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="flex-1">
                                    <label className="block mb-1.5">Jenis Cuti <span className="text-red-500">*</span></label>
                                    <select className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.jenis_cuti}>
                                        <option>{formDefaults.jenis_cuti}</option>
                                    </select>
                                </div>
                                <div className="flex-1">
                                    <label className="block mb-1.5">Alasan Cuti <span className="text-red-500">*</span></label>
                                    <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.alasan} />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.tgl_mulai} />
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.tgl_selesai} />
                                        <svg className="w-3.5 h-3.5 text-gray-400 absolute right-3 top-2.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"/></svg>
                                    </div>
                                </div>
                                <div className="w-24">
                                    <label className="block mb-1.5">Total Hari</label>
                                    <input type="text" disabled className="w-full bg-[#e8f5e9] border border-green-200 text-green-700 font-bold text-center text-sm rounded px-3 py-2.5 focus:outline-none" defaultValue={formDefaults.total_hari} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c] resize-none h-14" defaultValue={formDefaults.alamat}></textarea>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="flex-1">
                                    ...
                                    <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.telp} />
                                </div>
                                <div className="flex-1">
                                    <label className="block mb-1.5">Kontak Darurat</label>
                                    <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.darurat} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c] resize-none h-14" defaultValue={formDefaults.delegasi}></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="w-full bg-gray-50 border border-gray-200 rounded p-3 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-sm font-bold text-gray-800">{formDefaults.lampiran_nama}</div>
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                        ...
                        <div className="space-y-5 text-sm text-gray-800 font-medium">
                            ...
                            <div>
                                ...
                                <select className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.jenis_transport}>
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.tujuan} />
                            </div>
                            ...
                            <div className="flex gap-4">
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.tgl_berangkat} />
                                        <svg className="w-3.5 h-3.5 text-gray-400 absolute right-3 top-2.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"/></svg>
                                    </div>
                                </div>
                                <div className="flex-1">
                                    <label className="block mb-1.5">Jam Berangkat <span className="text-red-500">*</span></label>
                                    <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.jam_berangkat} />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.tgl_kembali} />
                                        <svg className="w-3.5 h-3.5 text-gray-400 absolute right-3 top-2.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"/></svg>
                                    </div>
                                </div>
                                <div className="flex-1">
                                    <label className="block mb-1.5">Jam Kembali <span className="text-red-500">*</span></label>
                                    <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.jam_kembali} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c]" defaultValue={formDefaults.penumpang} />
                            </div>

                            {/* Keterangan */}
                            <div>
                                <label className="block mb-1.5">Keterangan Tambahan</label>
                                <textarea className="w-full bg-white border border-gray-300 text-gray-800 text-sm rounded px-3 py-2.5 focus:outline-none focus:border-[#0a4d3c] resize-none h-16" defaultValue={formDefaults.keterangan_tambahan}></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                    <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-2 flex items-center gap-2">
                    ...
                    <p className="text-sm text-gray-500 mb-6">Form ini harus mendapatkan persetujuan berjenjang sesuai alur di bawah ini.</p>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-2 mb-10">
                    ...
                    <div className="flex gap-3">
                        <button className="bg-white hover:bg-gray-50 text-gray-700 font-bold px-5 py-2.5 rounded-lg text-sm transition border border-gray-300 flex items-center justify-center gap-2 shadow-sm">
