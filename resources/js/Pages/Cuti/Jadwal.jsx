...
export default function Jadwal({ auth, kpi, data }) {
    ...
    const renderRosterBadge = (roster) => {
        if (roster.includes('84')) return <span className="bg-purple-100 text-purple-600 font-bold px-2 py-1 rounded text-[10px]">{roster}</span>;
        if (roster.includes('70')) return <span className="bg-green-100 text-green-700 font-bold px-2 py-1 rounded text-[10px]">{roster}</span>;
        if (roster.includes('56')) return <span className="bg-blue-100 text-blue-600 font-bold px-2 py-1 rounded text-[10px]">{roster}</span>;
        return <span className="bg-gray-100 text-gray-700 font-bold px-2 py-1 rounded text-[10px]">{roster}</span>;
    };
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="flex flex-wrap items-end gap-3 mb-6">
                <div>
                    <label className="block text-[10px] font-bold text-gray-600 mb-1">Roster Kerja</label>
                    <select className="w-36 bg-white border border-gray-300 text-gray-800 text-xs rounded-lg px-2 py-2 focus:outline-none focus:border-[#0a4d3c]">
                        <option>84 : 14 Hari Kerja</option>
                    </select>
                </div>
                <div>
                    <label className="block text-[10px] font-bold text-gray-600 mb-1">Departemen</label>
                    <select className="w-40 bg-white border border-gray-300 text-gray-800 text-xs rounded-lg px-2 py-2 focus:outline-none focus:border-[#0a4d3c]">
                        <option>Semua Departemen</option>
                    </select>
                </div>
                <div>
                    <label className="block text-[10px] font-bold text-gray-600 mb-1">Jabatan</label>
                    <select className="w-40 bg-white border border-gray-300 text-gray-800 text-xs rounded-lg px-2 py-2 focus:outline-none focus:border-[#0a4d3c]">
                ...
                <div>
                    <label className="block text-[10px] font-bold text-gray-600 mb-1">Tahun</label>
                    <div className="relative">
                        <input type="text" className="w-28 bg-white border border-gray-300 text-gray-800 text-xs rounded-lg px-3 py-2 focus:outline-none focus:border-[#0a4d3c]" defaultValue="2025" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden flex flex-col justify-center">
                    <div className="text-[10px] font-bold text-blue-500 mb-1">Total Karyawan</div>
                    <div className="text-3xl font-black text-[#0b132b] mb-1">{kpi.total_karyawan}</div>
                    <div className="text-[10px] text-blue-500 font-medium">Orang</div>
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-blue-500"></div>
                </div>

                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden flex flex-col justify-center">
                    <div className="text-[10px] font-bold text-green-600 mb-1">Cuti Berjalan (Saat ini)</div>
                    <div className="text-3xl font-black text-[#0b132b] mb-1">{kpi.cuti_berjalan}</div>
                    <div className="text-[10px] text-green-600 font-medium">Orang</div>
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-green-500"></div>
                </div>

                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden flex flex-col justify-center">
                    <div className="text-[10px] font-bold text-orange-500 mb-1">Cuti Akan Datang (30 Hari)</div>
                    <div className="text-3xl font-black text-[#0b132b] mb-1">{kpi.cuti_akan_datang}</div>
                    <div className="text-[10px] text-orange-500 font-medium">Orang</div>
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-orange-400"></div>
                </div>

                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden flex flex-col justify-center">
                    <div className="text-[10px] font-bold text-purple-600 mb-1">Cuti Bulan Ini</div>
                    <div className="text-3xl font-black text-[#0b132b] mb-1">{kpi.cuti_bulan_ini}</div>
                    <div className="text-[10px] text-purple-600 font-medium">Orang</div>
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-purple-500"></div>
                </div>

                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden flex flex-col justify-center">
                    <div className="text-[10px] font-bold text-gray-700 mb-1">Rata - Rata Sisa POH</div>
                    <div className="text-3xl font-black text-[#0b132b] mb-1">{kpi.rata_sisa_poh}</div>
                    <div className="text-[10px] text-gray-700 font-medium">Hari</div>
            ...
            <div className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden mb-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-200">
                    <div className="flex">
                        <div className="px-6 py-4 border-b-2 border-[#0b5c3e] text-[#0b5c3e] font-bold text-xs cursor-pointer">
                            Jadwal Cuti (Berlanjut)
                        </div>
                        <div className="px-6 py-4 text-gray-500 font-medium text-xs cursor-pointer hover:text-gray-700">
                    ...
                    <div className="p-3 flex gap-2 w-full md:w-auto">
                        <div className="relative flex-1 md:w-64">
                            <input type="text" placeholder="Cari NRP, Nama, Jabatan..." className="w-full bg-gray-50 border border-gray-300 text-gray-800 text-xs rounded px-3 py-2 pl-3 focus:outline-none focus:border-[#0a4d3c] h-8" />
                        ...
                        <button className="bg-white hover:bg-gray-50 text-gray-700 font-bold px-3 py-1.5 rounded text-xs transition border border-gray-300 flex items-center justify-center gap-1.5 shadow-sm h-8">
                ...
                <div className="p-4 bg-white border-b border-gray-200">
                    <div className="bg-blue-50 border border-blue-100 text-blue-600 rounded p-3 text-[11px] flex items-center gap-2">
                ...
                <div className="px-5 py-4 border-b border-gray-200 flex justify-between items-center">
                    <h3 className="text-[11px] font-extrabold text-[#0b5c3e] uppercase tracking-wider">DAFTAR JADWAL CUTI PERIODIC (BERLANJUT)</h3>
                </div>
                ...
                {/* Pagination */}
                <div className="px-5 py-4 flex justify-between items-center text-xs text-gray-500 border-t border-gray-200">
                    <div>
