        ...
        <AuthenticatedLayout>
            ...
            <div className="mb-6 flex justify-between items-start md:items-center flex-col md:flex-row gap-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="text-sm text-[#0a4d3c] hidden sm:flex items-center gap-1">
                        <span>Home</span>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm mb-6 p-4 flex items-center justify-between text-sm overflow-x-auto">
                {/* Step 1 */}
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
                        <h3 className="text-sm font-extrabold text-[#0b132b] uppercase tracking-wider mb-4">INFORMASI WORK ORDER</h3>
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
                        <h3 className="text-sm font-extrabold text-[#0b132b] uppercase tracking-wider mb-4">INFORMASI UNIT / EQUIPMENT</h3>
                        <div className="space-y-3 text-sm text-gray-600 font-medium">
                            <div className="flex items-center">
                    ...
                    {/* INFORMASI PEKERJAAN */}
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
                        <h3 className="text-sm font-extrabold text-[#0b132b] uppercase tracking-wider mb-4">INFORMASI PEKERJAAN</h3>
                        <div className="space-y-3 text-sm text-gray-600 font-medium">
                            <div className="flex items-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
                        <div className="mb-6">
                            <h3 className="text-sm font-extrabold text-blue-800 uppercase tracking-wider mb-3">PROBLEM DESCRIPTION</h3>
                            <div className="font-bold text-sm text-[#0b132b] uppercase">{data.problem_description}</div>
                        </div>
                        <div>
                            <h3 className="text-sm font-extrabold text-blue-800 uppercase tracking-wider mb-3">JOB INSTRUCTION</h3>
                            <div className="font-bold text-sm text-[#0b132b] uppercase">{data.job_instruction}</div>
                        </div>
                    </div>

                    {/* Middle: Dokumentasi */}
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
                        <h3 className="text-sm font-extrabold text-blue-800 uppercase tracking-wider mb-4">DOKUMENTASI PEKERJAAN</h3>
                    ...
                    <div className="flex flex-col gap-4">
                        {/* INFORMASI TAMBAHAN */}
                        <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
                            <h3 className="text-sm font-extrabold text-blue-800 uppercase tracking-wider mb-4">INFORMASI TAMBAHAN</h3>
                            <div className="space-y-3 text-sm text-gray-600 font-medium">
                                <div className="flex items-center">
                        ...
                        <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-4 flex-1">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-sm font-extrabold text-blue-800 uppercase tracking-wider flex items-center gap-1.5">
                                ...
                                <button className="text-green-600 bg-green-50 hover:bg-green-100 font-bold px-2 py-1 rounded text-xs transition border border-green-200 flex items-center gap-1">
                                    + Tambah Lampiran
                                </button>
                            </div>
                ...
                <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5 mb-2">
                    <h3 className="text-sm font-extrabold text-blue-800 uppercase tracking-wider mb-5">APPROVAL & SIGNATURE</h3>
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <div className="flex flex-col">
                            <span className="text-xs text-gray-500 mb-2">Dibuat Oleh,</span>
                            <div className="h-16 border border-dashed border-gray-300 rounded mb-2"></div>
                            <span className="text-xs font-bold text-gray-900">Admin Plant</span>
                            <span className="text-xs text-gray-500 mt-1">Tanggal : ..........................</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-xs text-gray-500 mb-2">Diketahui Oleh,</span>
                            <div className="h-16 border border-dashed border-gray-300 rounded mb-2"></div>
                            <span className="text-xs font-bold text-gray-900">Planner</span>
                            <span className="text-xs text-gray-500 mt-1">Tanggal : ..........................</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-xs text-gray-500 mb-2">Disetujui Oleh,</span>
                            <div className="h-16 border border-dashed border-gray-300 rounded mb-2"></div>
                            <span className="text-xs font-bold text-gray-900">Superintendent Plant</span>
                            <span className="text-xs text-gray-500 mt-1">Tanggal : ..........................</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-xs text-gray-500 mb-2">Diterima Oleh,</span>
                            <div className="h-16 border border-dashed border-gray-300 rounded mb-2"></div>
                            <span className="text-xs font-bold text-gray-900">Logistik</span>
                            <span className="text-xs text-gray-500 mt-1">Tanggal : ..........................</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-xs text-gray-500 mb-2">Diterima Oleh,</span>
                            <div className="h-16 border border-dashed border-gray-300 rounded mb-2"></div>
                            <span className="text-xs font-bold text-gray-900">Head Office</span>
                            <span className="text-xs text-gray-500 mt-1">Tanggal : ..........................</span>
                        </div>
                    </div>
                </div>
