        ...
        <AuthenticatedLayout>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden">
                    <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-4">INFORMASI UNIT</h3>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-4">INFORMASI BACKLOG</h3>
                    
                    <div className="space-y-3">
                        <div className="grid grid-cols-[110px_10px_1fr] text-sm">
                            <div className="text-gray-500">No. Backlog</div>
                            <div>:</div>
                            <div className="font-bold text-gray-900">{backlog.no_backlog}</div>
                        </div>
                        <div className="grid grid-cols-[110px_10px_1fr] text-sm items-center">
                        ...
                        <div className="grid grid-cols-[110px_10px_1fr] text-sm mt-2">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm relative">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider">ALUR PROSES BACKLOG</h3>
                        <Link href="/backlogs" className="text-xs font-bold text-gray-500 hover:text-gray-800 border border-gray-200 rounded px-2 py-1 flex items-center gap-1 transition-colors">
                        ...
                        {backlog.timeline.map((item, idx) => (
                            <div key={idx} className="relative pl-6">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="text-sm font-mono text-gray-500 w-28 shrink-0 leading-tight">
                                        {item.waktu.split(' ')[0]}<br/>
                                        {item.waktu.split(' ')[1] || ''}
                                    </div>
                                    <div>
                                        <div className={`text-sm font-bold ${item.status === 'pending' ? 'text-gray-400' : 'text-gray-900'}`}>{item.judul}</div>
                                        {item.oleh !== '-' && <div className="text-xs text-gray-500 mt-0.5">{item.oleh}</div>}
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mb-6">
                ...
                {/* Detail Temuan */}
                <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-3">DETAIL TEMUAN / PEKERJAAN</h3>
                ...
                {/* Part Yang Diperlukan */}
                <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-3">PART YANG DIPERLUKAN</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-3">DOKUMENTASI TEMUAN</h3>
                    ...
                    <div>
                        <h3 className="text-sm font-extrabold text-[#0b5c3e] uppercase tracking-wider mb-3">CATATAN</h3>
            ...
            <div className="flex justify-end items-center gap-3 mb-10">
                <button className="bg-[#0b5c3e] hover:bg-[#08422c] text-white font-bold px-6 py-2.5 rounded-lg text-sm transition flex items-center justify-center gap-2 shadow-sm border border-[#0b5c3e]">
                ...
                <button className="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-2.5 rounded-lg text-sm transition flex items-center justify-center gap-2 shadow-sm border border-red-600">
